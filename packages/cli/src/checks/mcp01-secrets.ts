...
const PATTERNS: Pattern[] = [
	{
		...
		re: /\b(AKIA|ASIA|AGPA|AIDA|AROA|ANPA|ANVA|APKA)[0-9A-Z]{16}\b/g,
	},
	{
		id: 'MCP01-AWS-SK',
	...
	},
	{
		...
		re: /\bsk-ant-(?:api|admin)\d{0,3}-[A-Za-z0-9_-]{32,}/g,
	},
	{
		id: 'MCP01-OPENAI',
		label: 'OpenAI API key',
		re: /\bsk-(?!ant-)(?:proj-|svcacct-|admin-)?[A-Za-z0-9]{20}T3BlbkFJ[A-Za-z0-9]{20,}/g,
	},
	{
		id: 'MCP01-OPENAI-LEGACY',
		label: 'OpenAI legacy API key',
		re: /\bsk-(?!ant-)(?:proj-|svcacct-)?[A-Za-z0-9]{48}\b/g,
	},
	{ id: 'MCP01-GH-PAT', label: 'GitHub fine-grained PAT', re: /\bgithub_pat_[A-Za-z0-9_]{36,}/g },
	{
		id: 'MCP01-GH-CLASSIC',
		label: 'GitHub classic token',
		re: /\b(ghp|ghs|gho|ghu|ghr)_[A-Za-z0-9]{36}\b/g,
	},
	...
	{ id: 'MCP01-SLACK', label: 'Slack token', re: /\bxox[baprso]-[A-Za-z0-9-]{10,}/g },
	{
		...
		label: 'Slack webhook',
		re: /\bhttps:\/\/hooks\.slack\.com\/services\/T[A-Z0-9]+\/B[A-Z0-9]+\/[A-Za-z0-9]+/g,
	},
	...
	},
	{
		...
		re: /-----BEGIN (?:RSA |EC |DSA |OPENSSH |ENCRYPTED |PGP |)PRIVATE KEY-----/g,
	},
	{ id: 'MCP01-AZURE', label: 'Azure storage key', re: /AccountKey\s*=\s*[A-Za-z0-9+/=]{60,}/g },
	{
		id: 'MCP01-DISCORD',
		label: 'Discord bot token',
		re: /\b[MN][A-Za-z\d]{23}\.[\w-]{6}\.[\w-]{27,40}\b/g,
	},
	{
		id: 'MCP01-SENDGRID',
		label: 'SendGrid API key',
		re: /\bSG\.[A-Za-z0-9_-]{20,}\.[A-Za-z0-9_-]{30,}/g,
	},
	...
	{ id: 'MCP01-TWILIO-AUTH', label: 'Twilio auth token', re: /\bSK[a-f0-9]{32}\b/g },
	{
		...
		re: /heroku[_-]?(?:api[_-]?key|token)\s*[:=]\s*['"][a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}['"]/gi,
	},
	...
	{ id: 'MCP01-SQUARE', label: 'Square access token', re: /\b(?:sq0atp-|EAAA)[A-Za-z0-9_-]{22,}/g },
	{
		...
		re: /\b(?:dd[_-]?api[_-]?key|datadog[_-]?api[_-]?key)\s*[:=]\s*['"][a-f0-9]{32}['"]/gi,
	},
	...
	{ id: 'MCP01-PAGERDUTY', label: 'PagerDuty token', re: /\b(?:pdus|pdat)\+[A-Za-z0-9_-]{20,}/g },
	{
		...
		re: /\bcloudflare[_-]?(?:api[_-]?token|api[_-]?key)\s*[:=]\s*['"][A-Za-z0-9_-]{40,}['"]/gi,
	},
	{ id: 'MCP01-POSTMAN', label: 'Postman API key', re: /\bPMAK-[a-f0-9]{24}-[a-f0-9]{34}\b/g },
	{
		id: 'MCP01-ALGOLIA',
		label: 'Algolia admin key',
		re: /algolia[_-]?(?:admin[_-]?key|api[_-]?key)\s*[:=]\s*['"][a-f0-9]{32}['"]/gi,
	},
	{
		id: 'MCP01-SENTRY',
		label: 'Sentry DSN',
		re: /\bhttps:\/\/[a-f0-9]{32}@[a-z0-9.-]+\.ingest\.sentry\.io\/\d+/g,
	},
	{
		id: 'MCP01-SHOPIFY',
		label: 'Shopify access token',
		re: /\bshp(?:ss|at|ca|pa)_[a-f0-9]{32}\b/g,
	},
	{ id: 'MCP01-MAPBOX', label: 'Mapbox secret token', re: /\bsk\.eyJ1[A-Za-z0-9_-]{60,}/g },
	{
		id: 'MCP01-FIREBASE',
		label: 'Firebase Cloud Messaging key',
		re: /\bAAAA[A-Za-z0-9_-]{7}:[A-Za-z0-9_-]{140,}/g,
	},
	...
	{ id: 'MCP01-ASANA', label: 'Asana PAT', re: /\b1\/\d{16}:[a-f0-9]{32}\b/g },
	{
		...
		re: /\b(?:secret_|ntn_)[A-Za-z0-9]{43,}/g,
	},
...
const SKIP_FILE_RE =
	/(?:[\\/])(?:test|tests|__tests__|fixtures?|examples?)[\\/]|\.(?:test|spec)\.[cm]?[jt]sx?$/i;
